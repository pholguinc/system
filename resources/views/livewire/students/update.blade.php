...
<div wire:ignore.self class="modal fade" id="updateModal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
       <div class="modal-content">
            ...
            <div class="form-group">
                <label for="parents_name"></label>
                <input wire:model="parents_name" type="text" class="form-control" id="parents_name" placeholder="Parents Name">@error('parents_name') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group">
                <label for="phone_home"></label>
                <input wire:model="phone_home" type="text" class="form-control" id="phone_home" placeholder="Phone Home">@error('phone_home') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group">
                <label for="phone_parent"></label>
                <input wire:model="phone_parent" type="text" class="form-control" id="phone_parent" placeholder="Phone Parent">@error('phone_parent') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input wire:model="level_id" type="text" class="form-control" id="level_id" placeholder="Level Id">@error('level_id') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
...
<x-adminlte-modal id="editStudent" title="Crear Usuario" theme="dark" icon="fas fa-user-plus" size='lg'
    wire:ignore.self>
    ...
    <form autocomplete="off">
        ...
        <div class="form-group">
            <label for="address">Grado Académico:</label>
