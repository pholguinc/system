...
<x-adminlte-modal id="createUser" title="Crear Usuario" theme="dark" icon="fas fa-user-plus" size='lg'
    wire:ignore.self>

    <form autocomplete="off">
        <div class="form-group">
            <label for="code">Código</label>
            <input wire:model="code" type="text" class="form-control" id="code" placeholder="Ingrese código del alumno">
            @error('code')
    ...
    <x-slot name="footerSlot">
        ...
        <x-adminlte-button theme="success" icon="fas fa-save" label="Guardar" wire:loading.attr="disabled" wire:click.prevent="store()" class="close-modal" />
    </x-slot>
</x-adminlte-modal>
